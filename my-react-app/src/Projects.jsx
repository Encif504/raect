function Projects() {
    const projects = [
        { title: "Chicks", img: "/images/chicks.jpg", text: "Our chick project focuses on providing healthy,from day-old chicks to farmers and households. We offer improved kienyeji breeds. All chicks are vaccinated and raised under proper brooding conditions to ensure high survival rates and healthy growth." },
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" >
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {projects.map((p) => (
                    <article key={p.title} className="bg-white dark:bg-gray-600 rounded shadow overflow-hidden flex flex-col">
                        ...
                        <div className="p-4 flex-1 flex flex-col">
                            ...
                            <p className="text-gray-700 flex-1 dark:text-white font-sans">{p.text}</p>
                        </div>
                    </article>
                ))}
            </div>
