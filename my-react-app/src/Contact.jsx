      ...
      <div className="mt-10 flex flex-col lg:flex-row lg:items-start lg:gap-10">
        <form ref={formRef} className="w-full lg:w-2/3 bg-white dark:bg-gray-600 p-8 rounded-xl shadow-lg border border-amber-100 dark:border-amber-700" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-5 dark:text-black">
            <div>
              <label htmlFor="name" className="block text-left text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 font-sans">Name *</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div>
              <label htmlFor="phone" className="block text-left text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 font-sans">Phone</label>
              <input
                type="tel"
                id="phone"
                name="phone"
            ...
            <div>
              <label htmlFor="email" className="block text-left text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 font-sans">Email *</label>
              <input
                type="email"
                id="email"
                name="email"
            ...
            <div>
              <label htmlFor="subject" className="block text-left text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 font-sans">Subject</label>
              <input
                type="text"
                id="subject"
                name="subject"
            ...
            <div>
              <label htmlFor="message" className="block text-left text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 font-sans">Message</label>
              <textarea
                id="message"
                name="message"
