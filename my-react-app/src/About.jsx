      ...
      <section className="rounded overflow-hidden">
        <div className="relative bg-cover bg-center rounded" style={{ backgroundImage: "url('/images/improvedh.jpg')" }}>
          <div className="frost p-8 text-center">
            ...
            <p className="text-white font-semibold mt-2 bg-grey-600 ">We are a family owned farm built on hard work, trust, and a deep respect for nature. What started in 2020 as a simple idea has grown into a thriving, community focused farm that we are proud to call our own.
From the beginning, our goal was clear: produce healthy food in a way that is responsible, sustainable, and beneficial to the people around us. Every decision we make reflects that commitment.</p>
      ...
      <section className="mt-8 max-w-4xl mx-auto  px-4 sm:px-6 lg:px-8">
        ...
        <p className="dark:bg-gray-400 dark:text-black mt-4 text-gray-700 leading-relaxed bg-gray-200 px-4 py-4 ">
       ...
       <section className="mt-8 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 dark:bg-gray-400 dark:text-black text-gray-700 leading-relaxed bg-gray-200 px-4 py-4">
      ...
      <section className="mt-8">
        ...
        <p className="mt-4 text-gray-700 leading-relaxed dark:bg-gray-400 dark:text-black px-4 py-4">
      ...
      <section className="mt-8 bg-amber-800 text-white rounded p-6 text-center">
        ...
        <p className="frost mt-3  px-4 py-2 outline-1 outline-solid outline-white rounded  font-2xl font-bold">0740207040</p>
