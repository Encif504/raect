...
From the beginning, our goal was clear: produce healthy food in a way that is responsible, sustainable, and beneficial to the people around us. Every decision we make reflects that commitment.</p>
      ...
      <section className="mt-8 max-w-4xl mx-auto  px-4 sm:px-6 lg:px-8">
        ...
        <p className="rounded dark:bg-gray-600 dark:text-white mt-4 text-gray-700 leading-relaxed bg-gray-200 px-4 py-4 font-sans">
       ...
       <section className="mt-8 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="rounded mt-4 dark:bg-gray-600 dark:text-white text-gray-700 leading-relaxed bg-gray-200 px-4 py-4 font-sans">
      ...
      <section className="mt-8 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 grid md:flex gap-4 justify-around">
        ...
        <ul className="list-disc pl-5 bg-gray-200 dark:bg-gray-600 dark:text-white px-4 py-4 rounded font-sans">
      ...
      <section className="mt-8">
        ...
        <p className=" rounded mt-4 text-gray-700 leading-relaxed dark:bg-gray-600 dark:text-white px-4 py-4 font-sans">
      ...
      <section className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-600 dark:to-gray-500 p-6 rounded-xl shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
          ...
          <p className="text-gray-700 dark:text-gray-300 font-sans text-sm">We use sustainable farming practices that protect the environment for future generations.</p>
        </div>
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-600 dark:to-gray-500 p-6 rounded-xl shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
          <h3 className="text-xl font-bold text-amber-900 dark:text-amber-200 mb-2 font-serif">Quality</h3>
          <p className="text-gray-700 dark:text-gray-300 font-sans text-sm">Our products are produced with focus on healthy farming practices to ensure safe and reliable food.</p>
        </div>
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-600 dark:to-gray-500 p-6 rounded-xl shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
          <h3 className="text-xl font-bold text-amber-900 dark:text-amber-200 mb-2 font-serif">Freshness</h3>
          <p className="text-gray-700 dark:text-gray-300 font-sans text-sm">Our products are carefully handled to maintain their natural quality ensuring they reach customers in best condition.</p>
        </div>
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-600 dark:to-gray-500 p-6 rounded-xl shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
          <h3 className="text-xl font-bold text-amber-900 dark:text-amber-200 mb-2 font-serif">Community</h3>
          <p className="text-gray-700 dark:text-gray-300 font-sans text-sm">We value our local community and build lasting relationships with customers who trust our products.</p>
        </div>
      </section>
