    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6  lg:px-8 py-6 font-sans" id="home" name="home">
      <section className="relative mt-12 bg-cover bg-center rounded-lg overflow-hidden h-96 md:h-128" style={{ backgroundImage: "url('/images/hero.jpg')" }}>
        ...
        <div className="relative z-10 p-12 md:p-20 text-center">
          <h1 className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-amber-400 drop-shadow-lg transition-all duration-500 ease-in font-serif">Fresh, Sustainable Produce Straight from our farm</h1>
     ...
     <div className='place-items-center w-full mt-8 px-4 sm:px-6 lg:px-8'>
      ...
      <section className='mt-16 px-4 sm:px-6 lg:px-8'>
        ...
        <div className="bg-amber-100 bg-linear-to-br from-amber-50 to-amber-100 dark:from-gray-600 dark:to-gray-500 p-8 rounded-xl text-center shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
